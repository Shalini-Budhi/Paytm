  ...
  return (
      ...
      <div className="banner-wrapper">
        <div className="banner">
          ...
          <button className="banner-btn" onClick={handleDownload}>
            ...
            {/*FIXED image syntax */}
            <img src={bannerupi} alt="BannerUPI"  style={{height:" 107px",
    width: "83px"}}/>
      ...
      <div className="recharge-wrapper">
        <div className="recharge-box">
          ...
          <div className="recharge-items">
            {[
              ...
              { id: "electricity", img: electricity, label: "Electricity Bill" },
        ...
        <div className="side-card">
          <div className="className-text"><h3>
            Get Detailed Spend
            <br />
            Summary
          </h3>
          ...
          spends in a tap. <br/>
          Only on Paytm.</p>
          <button onClick={handleDownload} style={{"border-radius": "10px", "background-color": "black","color": "#ffffff"}}>Download App
            <FaApple className="store-icon" />
            <FaGooglePlay className="store-icon" />
          </button></div>
          <div className=""><img src={bannerupi} alt="" style={{width: "130px",height: "80%",marginLeft:"30px",marginTop: "50px"}}/></div>
        </div>
      ...
      <div className="promo-wrapper">
        <div className="promo-card1">
          <div className="promo-left">
            <div className="icon cashback">CASH<br />BACK</div>
            <div className="text">
              <h4>Do Mobile Recharge and Win ₹100</h4>
              <p>cashback. Promo: <b>TAKEITALL</b></p>
            </div>
          </div>
          ...
          <div key={card.id} className={`feature-card ${card.bg}`}>
            ...
            <div className="feature-phone">
              <div className="phone-placeholder">
                <img src={card.img} alt="" style={{width:"120%",height:"100%",borderRadius:"10px"}}/>
              </div>
            </div>
          </div>
        ))}
    ...
    <div className="travel-page">
      ...
      <div className="travel-tabs">
        ...
        <div className="paytm-logo">paytm <b>travel</b></div>
      </div>
      ...
      <div className="search-card">
        ...
        <div className="search-row">
          ...
          <div className="swap" onClick={swapCities}>⇄</div>
     ...
     <div className="upi-container">
      ...
      <div className="upi-left">
        ...
        <p>
          ...
          in-stores or online using Paytm UPI or directly from your
